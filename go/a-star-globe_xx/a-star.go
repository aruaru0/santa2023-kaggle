...
func bsf(start, last string, numWild int, moves map[string][]int16, limit int, timeout string) ([]string, bool) {
	...
	selMove := []string{}
	for _, e := range movelist {
		if globeInfo.pat[strings.Split(e, "_")[0]] == false {
			continue
		}
		selMove = append(selMove, e)
	}
...
func UpdateGlobeInfo() {
	x0 := globeInfo.target / (globeInfo.m * 2)
	x1 := globeInfo.n - x0

	globeInfo.pat = make(map[string]bool)

	// if globeInfo.target < (globeInfo.m*2)*(globeInfo.n+1)/2 {
	for _, e := range movelist {
		if e[:2] == "-f" {
	...
	// } else {
	// globeInfo.pat["f31"] = true
	// 	globeInfo.pat["f"+strconv.FormatInt(int64(globeInfo.m), 10)] = true
	// }
	globeInfo.pat["r"+strconv.FormatInt(int64(x0), 10)] = true
	globeInfo.pat["r"+strconv.FormatInt(int64(x1), 10)] = true
	globeInfo.pat["-r"+strconv.FormatInt(int64(x0), 10)] = true
	globeInfo.pat["-r"+strconv.FormatInt(int64(x1), 10)] = true
	fmt.Println("GlobalINFO", globeInfo)
	// os.Exit(0)
}
...
func main() {
	...
	// tmp := strings.Split(ddf.solution, ";")
	// for i := 66; i < 66*3; i++ {
	// 	tmp[i] = "x"
	// }
	// ddf.solution = strings.Join(tmp, ";")

	// tmp = strings.Split(ddf.initial, ";")
	// for i := 66; i < 66*3; i++ {
	// 	tmp[i] = "x"
	// }
	// ddf.initial = strings.Join(tmp, ";")

	fmt.Println(ddf.solution)
	fmt.Println(ddf.initial)
	...
	// 		// c[i] *= 2
	// 	}
	// 	for i := solLen / 2; i < solLen; i++ {
	// 		if i < solLen/2+solLen/4 {
	// 			idx[i] = i - m
	// 		} else {
	// 			idx[i] = i
	// 		}
	...
	for n := 0; n < loop; n++ {
		...
		// solState = "N0;N1;N2;N3;N4;N5;N6;N7;N8;N9;N10;N11;N12;N13;N14;N15;N16;N17;N18;N19;N20;N21;N22;N23;N24;N25;N26;N27;N28;N29;.;."
		// solState = "N0;N1;N2;N3;N4;N5;N6;N7;N8;N9;N10;N11;N12;N13;N14;N15;N16;N17;N18;N19;N20;N21;N22;N23;N24;N25;N26;N27;N28;N29;N30;N31;N32;N33;N34;N35;N36;N37;N38;N39;N40;N41;N42;N43;N44;N45;N46;N47;X;.;.;.;.;.;.;.;.;.;.;.;.;.;.;."
		...
		// state = "N0;N1;N2;N3;N4;N5;N6;N7;N8;N9;N10;N11;N12;N13;N14;N15;N16;N17;N18;N19;N20;N21;N22;N23;N24;N25;N26;N27;N28;.;N29;."
		// state = "N0;N1;N2;N3;N4;N5;N6;N7;N8;N9;N10;N11;N12;N13;N14;N15;N16;N17;N18;N19;N20;N21;N22;N23;N24;N25;N26;N27;N28;N29;N30;N31;N32;N33;N34;N35;N36;N37;N38;N39;N40;N41;N42;N43;N44;N45;N46;N47;.;.;.;.;.;.;.;.;.;.;.;.;.;.;.;X"
		fmt.Println("INIT  = ", state)

		diffPos := 0
		{
			sol := strings.Split(solState, ";")
			now := strings.Split(state, ";")
			for i := 0; i < len(sol); i++ {
				if now[i] != sol[i] {
					diffPos = i
					break
		...
		fmt.Println("DIFF = ", diffPos)
		globeInfo.target = diffPos
		UpdateGlobeInfo()
